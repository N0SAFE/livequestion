...
<body>
    ...
    <section class="section2">
        <div class="container notMedia clearfix padding-top-150 padding-bottom-100">
            <div class="gap-3 float-start">
                ...
                <p>Drogon sed ut perspiciatis unde omnis iste error sit voluptatem accusantium doloremque laudantiugn,
                    totam aperiam, eaque Arya</p>
            </div>
            <div class="gap-3 float-start">
                <img class="tailleImg" src="images/i2.png">
                <h3 class="padding-top-20">Ut posuere molestie</h3>
                <p>Duis convallis convallis tellus imp interdum. Non diam phasellus vestibulum lorem sed risus ultricies
                    Tyrion. Enim blandit volutpat.</p>
            </div>
            <div class="gap-3 float-start">
                ...
                <p>Eunuch sed blandit libero volutpat sed cras. Cersei quis imperdiet tincidunt unuch pulvinar sapien.
                    Habitasse platea Davos vestibulum.</p>
            </div>
        </div>
    ...
    <section class="section3 padding-top-75 padding-bottom-50">
        <div class="container center-600-px">
            ...
            <p class="padding-top-20 text-center">Sed ut perspiciatis unde omnis iste natus error sit voluptatem
            ...
            <div class="container clearfix padding-top-25 center-300-px lien">
                <button onclick="link1()" id="firstButton"
                    class="btn gap-3 color-pink text-center float-start padding-top-10 padding-bottom-10">Lien1</button>
                <button onclick="link2()" id="secondButton"
                    class="btn gap-3 color-pink text-center float-start padding-top-10 padding-bottom-10">Lien2</button>
                <button onclick="link3()" id="thirdButton"
                    class="btn gap-3 color-pink text-center float-start padding-top-10 padding-bottom-10">Lien3</button>
            </div>
        </div>
        <div id="firstlink" class="container center-70-percent lien1 padding-top-50 clearfix">
            ...
            <div class="container float-start gap-2 padding-left-50 padding-top-50 container-text">
                ...
                <p>Ned ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium,
    ...
    <section class="section4 padding-top-250 padding-bottom-250">
        <div class="center-600-px">
            <div class="container-fluid bigBlack badge clearfix">
                <img src="images/iplay.png" class="iplay float-start">
                <h2 class="text-light padding-left-10 div-auto float-start">"Nulla venenatis magna fringilla"</h2>
            </div>
        </div>
    </section>
    <section class="section5">
        <div class="container-fluid bigPink ">
            ...
            <p>Sed up perpiciatis unde omnis iste natus error sit voluptatem<br> accusantium doloremqe laudantium, totam
                rem aperiam aeque ipsa </p>
            <div class="container center-500-px padding-top-50">
                <button type="button " class="btn btn-light "><img src="images/marque1.jpg " class="imgMarque ">Kyan
                    Boards</button>
            ...
            <div class="container center-400-px padding-top-10 ">
                <button type="button " class="btn btn-light "><img src="images/marque5.jpg " class="imgMarque ">Tvit
                    Forms</button>
    ...
    <section class="section6 padding-bottom-100">
        <div class=" container-fluid faqDiv ">
            <h1>FAQ</h1>
            <p class="pDeFaq ">Sed up perpiciatis unde omnis iste natus error sit voluptatem<br> accusantium doloremqe
                laudantium, totam rem aperiam aeque ipsa </p>
            <br>
            <div class=" container-fluid center-500-px">
                <div class="btn-group dropend w-100">
                    <button type="button " class="btn dropdown-toggle border" data-toggle="dropdown"
                        aria-haspopup="true " aria-expanded="false "><strong>Can I upgrade later on ?</strong></button>
                </div>
                <div class="btn-group dropend w-100">
                    <button type="button " class="margin-top-10 btn border dropdown-toggle " data-toggle="dropdown"
                        aria-haspopup="true " aria-expanded="false "><strong>Can I port my data from another
                            provider?</strong></button>
                </div>
                <div class="btn-group dropend w-100">
                    <button type="button " class="margin-top-10 btn border dropdown-toggle " data-toggle="dropdown"
                        aria-haspopup="true " aria-expanded="false "><strong>Are my food photo stored forever in the
                            cloud?</strong></button>
                </div>
                <div class="btn-group dropend w-100">
                    <button type="button " class="margin-top-10 btn border dropdown-toggle " data-toggle="dropdown"
                        aria-haspopup="true " aria-expanded="false "><strong>Who foots the bills for
                            that?</strong></button>
                </div>
                <div class="btn-group dropend w-100">
                    <button type="button " class="margin-top-10 btn border dropdown-toggle " data-toggle="dropdown"
                        aria-haspopup="true " aria-expanded="false "><strong>What's the real cost?</strong></button>
                </div>
                <div class="btn-group dropend w-100">
                    <button type="button " class="margin-top-10 btn border dropdown-toggle " data-toggle="dropdown"
                        aria-haspopup="true " aria-expanded="false "><strong>Can my company request a custom
                            plan?</strong></button>
                </div>
            </div>
            <div class="padding-bottom-100 padding-top-25">
                <p class="abo bg-light center-300-px padding-bottom-10 padding-top-10">Still have unanswered question?
                    <a href="" class="aboLien">Get in touch</a></p>
            </div>
        </div>
    </section>
    <footer class="padding-top-300">
        ...
        <div class="container-fluid linkAll padding-top-10 padding-bottom-10 center-70-percent">
            <p class="links "> © 2019 Page protected by reCAPTCHA and subject to Google's <a class="decoration-none"
                    href="">Privacy Policy</a> and <a class="decoration-none" href=" ">Term of Service</a> </p>
